...
//! This code was adapted from embassy-rs OnceLock (also dual licensed under MIT and Apache)
...
// channel is owned by receiver, sender has a reference to it
pub fn channel<T>() -> (Sender<T>, Receiver<T>) {
    // todo!()
    // let x = Receiver(OnceLock::new());
...
///
/// edit: guaranteed initialization because only one sender
///
/// # Example
/// ```
